...
#include <vector>
using namespace std;
// TODO(v): add params to 4 draw functions
#include "rgbcolor.h"
...
class shape {
   ...
   public:
      ...
      virtual void draw (const vertex&, const rgbcolor&,
         const rgbcolor&, GLfloat, bool, int) const = 0;
...
class text: public shape {
   protected:
      void* glut_bitmap_font = GLUT_BITMAP_HELVETICA_18;
      // GLUT_BITMAP_8_BY_13
      // GLUT_BITMAP_9_BY_15
      ...
      string textdata;
   public:
      text (const string& fontName, const string& textdata);
      virtual void draw (const vertex&, const rgbcolor&,
         const rgbcolor&, GLfloat, bool, int) const override;
